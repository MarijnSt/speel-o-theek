<template>
  <div class="menu-container">
    ...
    <div class="items-container">
      <nuxt-link :to="localePath('catalog')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
      ...
      <nuxt-link :to="localePath('check-in')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      <nuxt-link :to="localePath('check-out')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      <nuxt-link :to="localePath('toy-admin')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      <nuxt-link :to="localePath('user-admin')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      <nuxt-link :to="localePath('reports')" class="menu-item" @click.native="chooseItem">
        <div class="icon-svg">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
